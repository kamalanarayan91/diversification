...
#      modified on an individual basis.102:#wand( 0.5 #and( fickle creek farm ) 0.25 #and( #near/1( creek farm )  #near/1( fickle creek ) ) 0.25 #and( #window/8( creek farm )  #window/8( fickle creek ) ) )

#

# example usage
print formulate_query( "fickle creek farm", "sd", 0.5, 0.25, 0.25 ) . "\n\n";
print formulate_query( "indiana child support", "sd", 0.5, 0.25, 0.25 ) . "\n\n";
print formulate_query( "universal animal cuts reviews", "sd", 0.5, 0.25, 0.25 ) . "\n\n";
print formulate_query( "ralph owen brewster", "sd", 0.5, 0.25, 0.25 ) . "\n\n";
print formulate_query( "map of brazil", "sd", 0.5, 0.25, 0.25 ) . "\n\n";
print formulate_query( "kenmore gas water heater", "sd", 0.5, 0.25, 0.25 ) . "\n\n";
print formulate_query( "adobe indian houses", "sd", 0.5, 0.25, 0.25 ) . "\n\n";
print formulate_query( "california franchise tax board", "sd", 0.5, 0.25, 0.25 ) . "\n\n";
print formulate_query( "poem in your pocket day", "sd", 0.5, 0.25, 0.25 ) . "\n\n";
print formulate_query( "tv on computer", "sd", 0.5, 0.25, 0.25 ) . "\n\n";
print formulate_query( "culpuper national cemetery", "sd", 0.5, 0.25, 0.25 ) . "\n\n";
print formulate_query( "bowflex power pro", "sd", 0.5, 0.25, 0.25 ) . "\n\n";
print formulate_query( "us capitol map", "sd", 0.5, 0.25, 0.25 ) . "\n\n";
print formulate_query( "atypical squamous cells", "sd", 0.5, 0.25, 0.25 ) . "\n\n";
print formulate_query( "fact on uranus", "sd", 0.5, 0.25, 0.25 ) . "\n\n";
print formulate_query( "mothers day songs", "sd", 0.5, 0.25, 0.25 ) . "\n\n";

print formulate_query( "electronic skeet shoot", "sd", 0.5, 0.25, 0.25 ) . "\n\n";
print formulate_query( "american military university", "sd", 0.5, 0.25, 0.25 ) . "\n\n";
print formulate_query( "jax chemical company", "sd", 0.5, 0.25, 0.25 ) . "\n\n";
print formulate_query( "east ridge high school", "sd", 0.5, 0.25, 0.25 ) . "\n\n";
print formulate_query( "illinois state tax", "sd", 0.5, 0.25, 0.25 ) . "\n\n";
print formulate_query( "trombone for sale", "sd", 0.5, 0.25, 0.25 ) . "\n\n";
print formulate_query( "sherwood regional library", "sd", 0.5, 0.25, 0.25 ) . "\n\n";
print formulate_query( "martha stewart and imclone", "sd", 0.5, 0.25, 0.25 ) . "\n\n";
print formulate_query( "tn highway patrol", "sd", 0.5, 0.25, 0.25 ) . "\n\n";
